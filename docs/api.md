...
The platform package exposes a Supabase REST API client. It defaults to URL `https://tiorfiqiowylbnartegx.supabase.co` and publishable key `sb_publishable_COw7A6dDU1xIxGqkgYcBOw_nygD-zBe`.
